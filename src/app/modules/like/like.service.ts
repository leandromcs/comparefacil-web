...
likeUrl = '/like';
    ...
    findLikeByPessoaAndColaboracao(idPessoa: number, idColaboracao: number): Observable<Like> {
        return this.httpClient.get(this.localhost + this.apiUrl + this.likeUrl + '/likeByPessoa/' + idPessoa + '/' + idColaboracao);
    }
}